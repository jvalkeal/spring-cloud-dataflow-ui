...
describe('StreamDeployBuilderComponent', () => {
  ...
  describe('Form values', () => {
    ...
    it('deployment properties on default should have no properties text', () => {
      const tr: DebugElement[] = fixture.debugElement.queryAll(By.css('.form-control > strong'));
      expect(tr.length).toBe(3);
      expect(tr[0].nativeElement.textContent).toContain('No properties');
      expect(tr[1].nativeElement.textContent).toContain('No properties');
      expect(tr[2].nativeElement.textContent).toContain('No properties');
    });
